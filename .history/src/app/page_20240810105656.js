      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 bg-pink-50">
          <div className="container px-4 md:px-6 space-y-8 lg:space-y-12">
            <div className="flex flex-col items-center justify-center text-center space-y-4">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-[#1b1124]">
        ...
        {issues && issues.length > 0 && (
          <section className="w-full py-12 md:py-24 lg:py-32">
            <div className="container px-4 md:px-6 space-y-8 lg:space-y-12">
              <div className="flex flex-col items-center justify-center text-center space-y-4">
                <div className="inline-block rounded-lg bg-pink-100 px-3 py-1 text-sm text-[#1b1124]">
                  Latest Issue
                </div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-[#1b1124]">
                  {issues[0].title}
                </h2>
              ...
              <div className="text-center">
                <Link
                  ...
                  className="inline-block bg-[#1b1124] text-white px-6 py-3 rounded-lg hover:bg-pink-700 transition-colors"
                >
                  Read Latest Issue
                </Link>
              </div>
                  ...
                  <Card key={issue.slug}>
                    ...
                    <CardFooter>
                      <Link
                        ...
                        className="text-[#1b1124] hover:underline"
                      >
                        Read Issue
                      </Link>
                    </CardFooter>
