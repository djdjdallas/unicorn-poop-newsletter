          ...
          <div className="container px-4 md:px-6 space-y-8 lg:space-y-12">
            <div className="flex flex-col items-center justify-center text-center space-y-4">
              ...
              <p className="max-w-[600px] text-gray-600 md:text-xl">
                Subscribe to the Unicorn Poop Newsletter for sparkles, rainbows,
                and magical updates straight to your inbox!
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Learn about our latest unicorn grooming tips.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p>
                    Discover the secrets to maintaining a vibrant, shimmering
                    mane that would make any unicorn proud.
                  </p>
                </CardContent>
                <CardFooter>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Get the scoop on the trendiest hoof designs.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p>
                    Our team of magical stylists shares the hottest glitter
                    patterns for your hooves this season.
                  </p>
                </CardContent>
                <CardFooter>
                  <Link href="#" className="text-pink-600">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Meet Sparkle, our featured unicorn!
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p>
                    Read about Sparkle's journey from a shy foal to the star of
                    Unicorn Valley's annual Rainbow Parade.
                  </p>
                </CardContent>
                <CardFooter>
                  <Link href="#" className="text-pink-600">
